...
{
    [TestClass]
    public class ChangeWalletPasswordPhraseFacts
    {
        [TestMethod]
        public void ShouldChangeTheWalletPasswordOrPhrase()
        {
            ...
            IChangeWalletPasswordPhrase systemUnderTest = new ChangeWalletPasswordPhrase(rpcContext);

            // Act
            ResponseInfo<object> response = systemUnderTest.Execute("old", "new").GetAwaiter().GetResult();
